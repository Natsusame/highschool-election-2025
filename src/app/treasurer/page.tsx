        ...
        <div className="flex flex-col items-center mt-5">
          <div className="flex items-center w-full mb-4">
            <div className="bg-white text-green-700 font-bold py-1 px-4 relative ml-[10%] inline-block align-middle">
              ...
              <h1 className="text-4xl ml-6 mb-2 inline-block align-middle mt-2 mr-4">会計</h1>
            </div>
          </div>
          <Image src="/treasurer.webp" alt="役職画像" width={300} height={300} className="max-w-full h-auto mt-5" />
