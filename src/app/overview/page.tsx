  ...
  return (
    <div className="bg-[#F1F1F1]">
      ...
      <main className="p-4 mt-20">
        ...
        {/* 選挙の仕組み */}
        <div className="bg-green-700 w-[20%] text-white font-bold py-2 px-4 h-12 relative ml-[10%]">
          <div className="absolute left-0 top-0 bottom-0 bg-white ml-1 mr-5 w-2"></div>
          <h2 className="text-3xl ml-6 mb-2">選挙の仕組み</h2>
        </div>
            <Image
            src="/./method.webp"
      ...
      {/* 役職紹介 */}
      <div className="bg-green-700 w-[15%] text-white fon</div>t-bold py-2 px-4 h-12 relative ml-[10%]">
          <div className="absolute left-0 top-0 bottom-0 bg-white ml-1 mr-5 w-2"></div>
          <h2 className="text-3xl ml-6 mb-2">役職紹介</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10 justify-center">
        ...
        <h2 className="text-xl mb-2">生徒会長</h2>
        <button 
        ...
        className="mb-4 md:mb-0 md:mr-2"
          />
          <div className="bg-green-700 text-white font-bold py-4 px-6 flex flex-col items-center justify-center w-full md:w-[200px] h-[200px]">
        <h2 className="text-xl mb-2">副会長</h2>
        <button 
          className="flex items-center justify-center bg-white text-green-700 rounded-full w-10 h-10 transition-transform duration-300 transform hover:scale-110"
        ...
        className="mb-4 md:mb-0 md:mr-2"
          />
          <div className="bg-green-700 text-white font-bold py-4 px-6 flex flex-col items-center justify-center w-full md:w-[200px] h-[200px]">
        <h2 className="text-xl mb-2">書記</h2>
        <button 
          className="flex items-center justify-center bg-white text-green-700 rounded-full w-10 h-10 transition-transform duration-300 transform hover:scale-110"
        ...
        className="mb-4 md:mb-0 md:mr-2"
          />
          <div className="bg-green-700 text-white font-bold py-4 px-6 flex flex-col items-center justify-center w-full md:w-[200px] h-[200px]">
        <h2 className="text-xl mb-2">会計</h2>
        <button 
          className="flex items-center justify-center bg-white text-green-700 rounded-full w-10 h-10 transition-transform duration-300 transform hover:scale-110"
